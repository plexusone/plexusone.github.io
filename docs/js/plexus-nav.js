...
`,fe="",ve=["library","agent","application","specification"],K={library:"/libraries",agent:"/agents",application:"/applications",specification:"/specifications"},J="https://github.com/plexusone",vt=[...be,k`
    :host {
      display: block;
    }
  ...
  `];var $t=Object.defineProperty,_t=Object.getOwnPropertyDescriptor,Z=c((o,e,t,s)=>{for(var i=s>1?void 0:s?_t(e,t):e,r=o.length-1,n;r>=0;r--)(n=o[r])&&(i=(s?n(e,t,i):n(i))||i);return s&&i&&$t(e,t,i),i},"__decorateClass$2");d.PlexusMegaMenu=(L=class extends f{constructor(){super(...arguments),this.open=!1,this.data=null,this.baseUrl="https://plexusone.dev",this._handleBackdropClick=()=>{this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))},this._handleLinkClick=()=>{this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}}_getProductsByCategory(e){return this.data?this.data.products.filter(t=>t.category===e&&t.featured&&t.docsUrl).slice(0,5):[]}_getCategoryCount(e){return this.data?this.data.products.filter(t=>t.category===e&&t.docsUrl).length:0}_getProductUrl(e){const t=K[e.category]||"/products";return`${this.baseUrl}${t}/${e.slug}`}_getCategoryUrl(e){return`${this.baseUrl}${K[e]}`}render(){if(!this.data)return h;const e=this.data.products.length,t=Object.keys(this.data.categories).length;return g`
    ...
    `}},c(L,"PlexusMegaMenu"),L),d.PlexusMegaMenu.styles=vt,Z([y({type:Boolean,reflect:!0})],d.PlexusMegaMenu.prototype,"open",2),Z([y({type:Object})],d.PlexusMegaMenu.prototype,"data",2),Z([y({type:String})],d.PlexusMegaMenu.prototype,"baseUrl",2),d.PlexusMegaMenu=Z([me("plexus-mega-menu")],d.PlexusMegaMenu);const yt=[...be,k`
    :host {
      display: none;
    }
  ...
  `];var xt=Object.defineProperty,kt=Object.getOwnPropertyDescriptor,Q=c((o,e,t,s)=>{for(var i=s>1?void 0:s?kt(e,t):e,r=o.length-1,n;r>=0;r--)(n=o[r])&&(i=(s?n(e,t,i):n(i))||i);return s&&i&&xt(e,t,i),i},"__decorateClass$1");d.PlexusMobileMenu=(H=class extends f{constructor(){super(...arguments),this.open=!1,this.data=null,this.baseUrl="https://plexusone.dev",this._handleLinkClick=()=>{this.dispatchEvent(new CustomEvent("close",{bubbles:!0,composed:!0}))}}render(){return this.data?g`
      <div class="mobile-menu" role="navigation" aria-label="Mobile navigation">
        <!-- Products section -->
        <div class="mobile-section">
          <span class="mobile-label">Products</span>
          ${ve.map(e=>{var i;const t=(i=this.data)==null?void 0:i.categories[e];if(!t)return h;const s=`${this.baseUrl}${K[e]}`;return g`
    ...
    `}},c(N,"PlexusNav"),N),d.PlexusNav.styles=gt,b([y({type:Object})],d.PlexusNav.prototype,"config",2),b([W()],d.PlexusNav.prototype,"_data",2),b([W()],d.PlexusNav.prototype,"_megaMenuOpen",2),b([W()],d.PlexusNav.prototype,"_mobileMenuOpen",2),b([W()],d.PlexusNav.prototype,"_activeDropdown",2),b([Y(".nav-mobile-toggle")],d.PlexusNav.prototype,"_mobileToggle",2),b([Y(".megamenu-trigger")],d.PlexusNav.prototype,"_megaMenuTrigger",2),b([Y('[data-dropdown="developers"]')],d.PlexusNav.prototype,"_developersDropdown",2),b([Y('[data-dropdown="community"]')],d.PlexusNav.prototype,"_communityDropdown",2),d.PlexusNav=b([me("plexus-nav")],d.PlexusNav);function qe(){const o=document.getElementById("plexus-nav-root");if(o&&!o.querySelector("plexus-nav")){const e=document.createElement("plexus-nav");o.appendChild(e)}}return c(qe,"autoInit"),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",qe):qe(),d.CATEGORY_ORDER=ve,d.CATEGORY_PATHS=K,d.DEFAULT_BASE_URL=fe,d.GITHUB_URL=J,Object.defineProperty(d,Symbol.toStringTag,{value:"Module"}),d}({});
